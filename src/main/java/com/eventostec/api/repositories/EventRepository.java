...
public interface EventRepository extends JpaRepository<Event, UUID> {
    ...
    List<EventAddressProjection> findUpcomingEvents(@Param("currentDate") Date currentDate, Pageable pageable);
    ...
    List<EventAddressProjection> findFilteredEvents(@Param("city") String city,
                                                    @Param("uf") String uf,
